...
export const LstList: LST[] = [
  {
    ...
    "pool": {
      ...
      "validatorList": "9PYGjoQhY89f8t3NVtq82MN91RDvoEkkFtcQyuVAuWGL"
    }
  },
  {
  ...
  },
  {
    ...
    "pool": {
      "program": "Spl",
      "pool": "CgntPoLka5pD5fesJYhGmUCF8KU1QS1ZmZiuAuMZr2az",
      "validatorList": "CGNTvFQ5yhxp2H5RmmXJ2w3LXJ3kAHrgPMrfABBTkeTr"
    }
  },
  {
    "name": "daoSOL",
    ...
    "pool": {
      "program": "Spl",
      "pool": "7ge2xKsZXmqPxa3YmXxXmzCp9Hc2ezrTxh6PECaxCwrL",
      "validatorList": "CKG4Jci9tGSrZtetnLXuDKV2WqaknFCUX9CY3ahfw2n6"
    }
  },
  {
    ...
    "pool": {
      ...
      "validatorList": "3R3nGZpQs2aZo5FDQvd2MUQ6R7KhAPainds6uT6uE2mn"
    }
  },
  {
    ...
    "pool": {
      "program": "Spl",
      "pool": "CtMyWsrUtAwXWiGr9WjHT5fC3p3fgV8cyGpLTo2LJzG1",
      "validatorList": "Ei2LhH2tDKPERnoNjQV5darTToZmbg45vDvftFFLNNWd"
    }
  },
  {
    ...
    "pool": {
      ...
      "validatorList": "sHPN95ARJpwN3Yipc22Z3m5118K3czRLBG7WmLDLsMp"
    }
  },
  {
    ...
    "pool": {
      "program": "Spl",
      "pool": "DqhH94PjkZsjAqEze2BEkWhFQJ6EyU6MdtMphMgnXqeK",
      "validatorList": "77Nc7i2Pe4ktkPVsk2KsZeLZRMUMKpddheBUgW727XR4"
    }
  },
  {
    "name": "riskSOL",
    "symbol": "riskSOL",
    "mint": "C4kq9QRFLAqwYHK7p4Ez54KMZLZNw2yLsiT3KN4FSmdH",
    "decimals": 9,
    "tokenProgram": "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA",
    "logoUri": "https://risk.lol/static/media/riskNft.0ec25135.gif",
    "pool": {
      "program": "Spl",
      "pool": "F8h46pYkaqPJNP2MRkUUUtRkf8efCkpoqehn9g1bTTm7",
      "validatorList": "3p3pwXkx15WSphpmcQyBqJ235pMVQkLYM9t2faBH1Zix"
    }
  },
  {
  ...
  },
  {
    ...
    "pool": {
      "program": "Socean",
      "pool": "5oc4nmbNTda9fx8Tw57ShLD132aqDK65vuHH4RU1K4LZ",
      "validatorList": "8pTa29ovYHxjQgX7gjxGi395GAo8DSXCRTKJZvwMc6MR"
    }
  }
];